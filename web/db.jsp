...
<head>
    ...
    <title>Supply Chain Checklist</title>
				...
				<div class="panel-body">
						...
						<div class="panel panel-body login-form">
							<div class="text-center header">
                                <div class="title">Supply Chain System</div>
							...
							<!--<div class="form-group ">-->
                                                        <div class="form-group">
                                                          ...
                                                          <div class="form-group">
                                                                ...
                                                                <input id="database"  type=text required name="database" value="supply_chain"  class="form-control" placeholder="supply system">
                                                            </div>
